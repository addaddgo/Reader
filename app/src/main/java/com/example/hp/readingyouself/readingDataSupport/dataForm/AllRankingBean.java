...
public class AllRankingBean {
    ...
    private List<BaseBean> picture;
    private List<BaseBean> epub;
    ...
    public List<BaseBean> getPicture() {
        return picture;
    }

    public void setPicture(List<BaseBean> picture) {
        this.picture = picture;
    }

    public List<BaseBean> getEpub() {
        return epub;
    }

    public void setEpub(List<BaseBean> epub) {
        this.epub = epub;
    }

    public static class MaleBean extends BaseBean{
        /**
