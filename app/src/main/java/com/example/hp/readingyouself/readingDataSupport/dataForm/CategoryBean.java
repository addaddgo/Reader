...
public class CategoryBean {
    ...
    private boolean ok;
    private List<FoundationBean> male;
    private List<FoundationBean> female;
    private List<FoundationBean> picture;
    private List<FoundationBean> press;
    ...
    public List<FoundationBean> getMale() {
        return male;
    }

    public void setMale(List<FoundationBean> male) {
        this.male = male;
    }

    public List<FoundationBean> getFemale() {
        return female;
    }

    public void setFemale(List<FoundationBean> female) {
        this.female = female;
    }

    public List<FoundationBean> getPicture() {
        return picture;
    }

    public void setPicture(List<FoundationBean> picture) {
        this.picture = picture;
    }

    public List<FoundationBean> getPress() {
        return press;
    }

    public void setPress(List<FoundationBean> press) {
        this.press = press;
    }
